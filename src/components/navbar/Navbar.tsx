import { FirstAidKit, ShoppingCartSimple, User } from "phosphor-react";
import { Link } from "react-router-dom";

function Navbar() {
    return (
        <div className="px-6 py-4 text-lg bg-cyan-300 text-black font-semibold">
            <div className="flex justify-between">
                
                <Link to={'/'} className="text-lg flex gap-5"><FirstAidKit size={32} /></Link>
